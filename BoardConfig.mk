...
ifneq (,$(filter %hentai_griffin_RoW,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := J8110
else ifneq (,$(filter %hentai_griffin_DSDS,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := J9110
else ifneq (,$(filter %hentai_griffin_RoW_Go,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := J8110
else ifneq (,$(filter %hentai_griffin_DSDS_Go,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := J9110
else
TARGET_BOOTLOADER_BOARD_NAME := J8110
